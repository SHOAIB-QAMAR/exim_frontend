...
const WelcomeScreen = ({
    ...
    <div className="relative flex flex-col h-full bg-gradient-to-b from-[var(--bg-secondary)] via-[var(--bg-secondary)] to-[var(--bg-tertiary)]/30">
        <div className="flex-1 flex flex-col overflow-y-auto custom-scrollbar w-full px-4 pb-4 pt-10 md:pt-0 md:justify-center md:items-center">
            <div className="flex flex-col items-center w-full max-w-[1000px] md:m-auto">
